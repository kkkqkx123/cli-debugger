/**
 * Event collector for Delve integration testing
 * Collects and manages debug events during tests
 */

import type { DebugEvent } from "../../../../src/types/debug.js";
import type { DlvClient } from "../../../../src/protocol/dlv/client.js";

/**
 * Event collector for Delve
 */
export class DlvEventCollector {
   ...
   */
  async collect(client: DlvClient, duration: number): Promise<DebugEvent[]> {
  ...
  /**
   * Find events by thread ID (goroutine ID in Go)
   */
